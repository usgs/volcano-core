...
public class GeoRange 
{
	...
	public int hashCode()
	{
		return new Double(west).hashCode() + new Double(east).hashCode() + new Double(south).hashCode() + new Double(north).hashCode();
	}
	...
	{
		return !Double.isNaN(west) && !Double.isNaN(east) && !Double.isNaN(south) && !Double.isNaN(north);
	}
...
//			System.out.println(" " + pt[i]);
	...
	{
		Point2D.Double[] tps = new Point2D.Double[] {
				new Point2D.Double(165, 60),
				new Point2D.Double(170, 60),
				new Point2D.Double(175, 60),
				new Point2D.Double(-180, 60),
				new Point2D.Double(180, 60),
				new Point2D.Double(-175, 60),
				new Point2D.Double(-172, 60),
				new Point2D.Double(-170, 60),
				new Point2D.Double(-160, 60)
				};
...
//				new GeoRange(170, -171, 0, 45),
	...
	public static void main(String[] args)
	{
		...
		double[] d = new double[] {-1E300, -720, -510, -360, -270, -180, -90, 0, 90, 180, 270, 360, 510, 720, 1E300 };
