...
public class Types {
	...
	/**
	 * Converts array of bytes into string on per-symbol basis, till first 0
	 * value
	 * 
	 * @param b
	 ...
	 *            byte array to convert
	 * @param o
	 *            number of first byte to convert
	 * @param l
	 *            length of converting part
	 * @return converted string
	 */
	 ...
	 *            byte array to convert
	 * @param ofs
	 *            offset from first array member to start conversion
	 * @param len
	 ...
	 * 
	 * @param val
	 *            the string that represents the boolean
	 * @return the boolean
	 */
	 ...
	 * 
	 * @param val
	 *            the string that represents the integer
	 * @return the integer
	 */
	...
	/**
	 * Converts a string to a double, sets to <code>Double.NaN</code> if there's
	 * an exception.
	 * 
	 * @param val
	 *            the string that represents the double
	 * @return the double
	 */
	...
	/**
	 * Converts a string to a double, sets to user-specified default if there's
	 * an exception.
	 * 
	 * @param val
	 *            the string that represents the double
	...
	/**
	 * Converts map to string which consist from pairs key=value, divided by
	 * semicolon
	 * 
	 * @param map
	...
	/**
	 * Converts string which consist from pairs key=value, divided by semicolon
	 * to map
	 * 
	 * @param src
