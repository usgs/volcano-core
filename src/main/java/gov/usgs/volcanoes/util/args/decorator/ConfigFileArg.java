...
/**
 * Gather a config filename from the command line and place it in
 * "config-filename". The filename is taken from the first available unflagged
 * option. Be careful of the order that Args are added.
 * 
 * @author Tom Parker
 * 
...
public class ConfigFileArg extends ArgsDecorator {
	 ...
	 *            The value to assign if the parameter is not given on the
	 *            command line
	 * @param nextArg
	 *            The next Arguments object in the chain.
	 * @throws JSAPException
	 *             If new Parameter cannot be craeted. Not sure why this would
	 *             happen
	 */
